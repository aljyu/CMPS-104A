...
fielddecl   : basetype TOK_ARRAY TOK_IDENT
                                    { 
                                      $3 = convert ($3, TOK_FIELD);
                                      $$ = adopt2 ($2, $1, $3);
                                    }
            | basetype TOK_IDENT    { 
                                      $2 = convert ($2, TOK_FIELD);
                                      $$ = adopt1 ($1, $2);
                                    }
            ;
...
basetype    : TOK_VOID              { $$ = $1; }
            ...
            | TOK_INT               { $$ = $1; }
            | TOK_STRING            { $$ = $1; }
            | TOK_IDENT             { $$ = convert ($1, TOK_TYPEID); }
            ;

function    : identdecl '(' ')' ';' { 
                                      free_ast2 ($3, $4);
                                      $2 = convert ($2, TOK_PARAMLIST);
                                      $$ = new astree (
                                             TOK_PROTOTYPE,
                                           $1->astree::lloc,
                                             ""
...
identdecl   : basetype TOK_ARRAY TOK_IDENT 
                                    { 
                                      $3 = convert ($3, TOK_DECLID);
                                      $$ = adopt2 ($2, $1, $3);
                                    }
            | basetype TOK_IDENT    { 
                                      $2 = convert ($2, TOK_DECLID);
                                      $$ = adopt1 ($1, $2);
                                    }
            ;
            ...
            | TOK_NEW TOK_STRING '(' expr ')'
                                    {
                                      free_ast ($2);
                                      free_ast2 ($3, $5);
                                      $1 = convert ($1, TOK_NEWSTRING);
                                      $$ = adopt1 ($1, $4);
                                    }
            | TOK_NEW basetype '[' expr ']'
                                    {
                                      free_ast2 ($3, $5);
                                      $1 = convert ($1, TOK_NEWARRAY);
                                      $$ = adopt2 ($1, $2, $4);
                                    }
            ;
